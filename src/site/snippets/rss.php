...
<rss version="2.0" xmlns:content="http://purl.org/rss/1.0/modules/content/"  xmlns:atom="http://www.w3.org/2005/Atom" xmlns:georss="http://www.georss.org/georss" xmlns:gml="http://www.opengis.net/gml">
  <channel>
    <title>Careful Digital Blog</title>
    <link>https://careful.digital/commons/blog/</link>
    <description>What's new on the Careful Digital blog</description>
    <language>en</language>
    <pubDate><?=date('r', time())?></pubDate>
    <lastBuildDate><?=date('r', time())?></lastBuildDate>
    <atom:link href="https://careful.digital/feed/index.xml" rel="self" type="application/rss+xml"/>
