<header>
  ...
  <nav class="main">
    ...
    <div id="commons-menu">
      <a href="/commons"><strong>Commons</strong></a>
      <ul class="menu">
        <li class="nav-item"><a href="/commons/guides/" class="nav-link px-2 text-white">Guides</a></li>
        <li class="nav-item"><a href="/commons/resources/" class="nav-link px-2 text-white">Resources</a></li>
