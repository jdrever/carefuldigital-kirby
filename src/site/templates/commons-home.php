...
<div class="container px-4" id="featured-3">
  <div class="row g-4 py-2 row-cols-1 row-cols-lg-2">
    <div class="feature col">
      ...
      <a href="/commons/guides/" class="btn btn-sm btn-outline-secondary">
        Browse the Guides
      </a>
    </div>
    <div class="feature col">
      ...
      <a href="/commons/resources/" class="btn btn-sm btn-outline-secondary">
    ...
    <div class="feature col">
      ...
      <a href="/commons/blog/" class="btn btn-sm btn-outline-secondary">
        Browse the Blog
      </a>
    </div>
    <div class="feature col">
